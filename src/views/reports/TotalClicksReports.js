...
const TotalClicksReports = () => {
    ...
    const defferContent = <>
        <Row className='justify-content-end mx-0'>
            ...
            <Col className='d-flex align-items-center justify-content-center' md='4' sm='12'>
                <h4 className='m-0'>Total Clicks</h4>
            </Col>
    ...
    const columns = [
        ...
        },
        {
            name: 'Type',
            cell: (row) => {
                return row.cust_visit === 1 || row.cust_visit === "1" ? "Acq" : "Ret"
            },
            width: '100px'
        },
        {
    ...
    const getData = () => {
        setIsLoading(true)
        getReq('TotalClicksReports', `?page=${currentPage + 1}&size=${currentEntry}&searchValue=${searchValue}`)
        .then((resp) => {
            console.log(resp)
...
export default TotalClicksReports
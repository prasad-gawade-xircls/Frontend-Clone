...
const OwnRedemptions = () => {
    ...
    const defferContent = <>
        <Row className='justify-content-end mx-0'>
            ...
            <Col className='d-flex align-items-center justify-content-center' md='4' sm='12'>
                <h4 className='m-0'>Offers Redeemed - Own Customers</h4>
            </Col>
    ...
    const getData = () => {
        setIsLoading(true)
        getReq('OwnRedemptionsReports', `?page=${currentPage + 1}&size=${currentEntry}&searchValue=${searchValue}`)
        .then((resp) => {
            console.log(resp)

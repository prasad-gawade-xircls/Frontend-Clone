...
const IncentiveViewOwn = () => {
    ...
    const defferContent = <>
        <Row className='justify-content-end mx-0'>
            ...
            <Col className='d-flex align-items-center justify-content-center' md='4' sm='12'>
                <h4 className='m-0'>Incentives Viewed Own</h4>
            </Col>
    ...
    const getData = () => {
        setIsLoading(true)
        getReq('IncentiveViewOwn', `?page=${currentPage + 1}&size=${currentEntry}&searchValue=${searchValue}`)
        .then((resp) => {
            console.log(resp)
...
export default IncentiveViewOwn
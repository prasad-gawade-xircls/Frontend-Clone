...
const ThankYou = () => {
    ...
    return (
        <Container fluid className="plugin">
            <Container className="border" style={{ padding: '2rem 2rem 0 2rem' }}>
                <Row className="mb-2">
                    <div>
            ...
            <Container className="border mt-2" style={{ padding: '0 2rem 2rem 2rem' }}>
                <Row className="my-2">
                    <div className="d-flex align-items-center ">
                        ...
                        <div className="form-check-success form-switch d-flex">
                            <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" onClick={() => setstatus(!status)} checked={status} style={{ marginRight: '50px' }} />
                        </div>
                        <div>
